...
def test_simple_datastats_load() -> None:
    museums_spec = get_test_case_path("dotastats_with_simple_pagination.yml")
    ...
    dltsource = get_source_from_open_api(museums_spec, base_url="https://api.opendota.com/api")
